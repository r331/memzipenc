...
public class EncryptZipOutput extends EncryptDeflater implements ZipConstants {
    ...
    private Vector<EncryptZipEntry> entries = new Vector<EncryptZipEntry>();
    private Hashtable<String, EncryptZipEntry> names = new Hashtable<String, EncryptZipEntry>();
     ...
     */
    public static final int STORED = EncryptZipEntry.STORED;

    /**
     * Compression method for compressed (DEFLATED) entries.
     */
    public static final int DEFLATED = EncryptZipEntry.DEFLATED;
    ...
    public EncryptZipOutput(OutputStream out, String password, int compressLevel) {
        super(out, new Deflater(compressLevel, true));
        this.password = password;
        if (compressLevel == Deflater.DEFAULT_COMPRESSION) {
            this.usesDefaultDeflater = true;
        }
    }
    ...
    public void finish() throws IOException {
        ...
        Enumeration<EncryptZipEntry> e = entries.elements();
